    ...
    <div class="container">
        <div class="flex flex-wrap justify-center items-center">
            <div class="w-2/5 flex flex-wrap items-center justify-center">
                <img src="{{ asset('img/14.png') }}" alt="" class="w-3/4 lg:-mt-16">
                <p class="font-semibold text-xl text-center lg:z-10 lg:-mt-20">Rekam Jejak Kelompok Riset <span
                        class="text-red-500">Software Development</span></p>
            </div>
            <div class="md:w-3/5 mt-7">
                <div class="max-w-6xl mx-auto p-6">
                    <div class="relative">
                        ...
                        @if (optional($softwareDevelopment)->count() > 0)
                        <!-- Gambar di atas -->
                        ...
                        @endif
                        @forelse ($softwareDevelopment as $index => $item)
