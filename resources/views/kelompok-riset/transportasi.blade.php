            ...
            <div class="md:w-3/5 mt-7">
                <div class="max-w-6xl mx-auto p-6">
                    <div class="relative">
                        ...
                        @if (optional($transportasi)->count() > 0)
                        <!-- Gambar di atas -->
                        ...
                        @endif
                        @forelse ($transportasi as $index => $item)
