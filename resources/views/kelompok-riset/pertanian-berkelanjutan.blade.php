        ...
        <div class="container">
            <div class="flex flex-wrap justify-center items-center">
                <div class="w-2/5 flex flex-wrap items-center justify-center">
                    <img src="{{ asset('img/9.png') }}" alt="" class="w-3/4 lg:-mt-16">
                    <p class="font-semibold text-xl text-center lg:z-10 lg:-mt-20">Rekam Jejak Kelompok Riset <span
                            class="text-red-500">Pertanian Berkelanjutan</span></p>
                </div>
                    ...
                    <div class="max-w-6xl mx-auto p-6">
                        <div class="relative">
                            ...
                            <div class="absolute left-1/2 transform -translate-x-1/2 w-4 bg-gray-500 h-full">
                                ...
                                <div class="absolute left-1/2 transform -translate-x-1/2 h-full" style="border-left: 2px dashed white;">
                                </div>
                            
                                <!-- Gambar di atas -->
                            </div>
                            @if (optional($pertanianBerkelanjutan)->count() > 0)
                            <!-- Gambar di atas -->
                            ...
                            @endif
                            @forelse ($pertanianBerkelanjutan as $index => $item)
