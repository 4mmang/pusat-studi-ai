        ...
        <div class="container">
            ...
            <div class="w-full flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
                <div class="p-4 md:w-1/2 w-full">
                    <a href="mailto:pusatstudiai@unsulbar.ac.id?subject=Pertanyaan tentang AI&body=Halo, saya ingin bertanya tentang program AI di Unsulbar.">
                    ...
                    <div class="border p-6 shadow-lg bg-white flex items-center space-x-4">
                        <form class="w-full" action="" method="post">
                            ...
                            <div class="flex flex-wrap space-y-4 md:space-y-0 md:flex-nowrap md:space-x-4">
                                ...
                                <div class="mb-4 w-full md:w-1/3">
                                    <label for="number_phone" class="block text-gray-700 text-sm font-bold mb-2">No,
                                        Handphone:</label>
                            ...
                            <button type="submit" class="border p-3 bg-primary text-white px-7 rounded-full"><i
