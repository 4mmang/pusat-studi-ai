...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <p class="fs-2 mb-0" style="color: #38527E">Tambah Parnert Baru</p>
    </div>
    <!-- Content Row -->
    <div class="row">
        <div class="col-md-12">
            <div class="card p-3">
                <form id="parnert-baru" action="{{ route('parnert.store') }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="file" class="form-control @error('logo')
                                    is-invalid
                                @enderror" name="logo" id="logo" required>
                        </div>
                    </div>
...
@push('scripts')
<script>
    let form = document.getElementById('parnert-baru')
