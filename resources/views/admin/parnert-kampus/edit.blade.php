...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <p class="fs-2 mb-0" style="color: #38527E">Edit Parnert Kampus</p>
    </div>
    <!-- Content Row -->
    <div class="row">
        <div class="col-md-12">
            <div class="card p-3">
                <form id="parnert-edit" action="{{ route('parnert.update', $parnert->id) }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama')
                                    is-invalid
                                @enderror" name="nama" value="{{ $parnert->nama }}" id="nama" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <a href="{{ route('parnert.index') }}" class="btn btn-danger float-end mt-3 ml-2">Kembali</a>
...
@push('scripts')
<script>
    let form = document.getElementById('parnert-edit')
