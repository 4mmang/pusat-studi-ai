...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <p class="fs-2 mb-0" style="color: #38527E">Edit Event</p>
        </div>
        <!-- Content Row -->
        <div class="row">
            <div class="col-md-12">
                <div class="card p-3">
                    <form id="event-baru" action="{{ route('event.update', $event->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    name="judul" id="judul" value="{{ $event->judul }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="link_pendaftaran" class="">Link Pendaftaran <sup
                                        class="text-danger">*</sup></label>
                                <input type="url" value="{{ $event->link_pendaftaran }}"
                                    class="form-control @error('link_pendaftaran')
                                    is-invalid
                                @enderror"
                                    name="link_pendaftaran" id="link_pendaftaran" required>
                            </div>
                        </div>
