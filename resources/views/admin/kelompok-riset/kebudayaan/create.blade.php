...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card p-3">
                <form id="kebudayaan-baru" action="{{ route('kebudayaan.store') }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control @error('tahun')
                                    is-invalid
                                @enderror" name="tahun" id="tahun" required>
                        </div> 
                    </div>
...
@push('scripts')
<script>
    let form = document.getElementById('kebudayaan-baru')
