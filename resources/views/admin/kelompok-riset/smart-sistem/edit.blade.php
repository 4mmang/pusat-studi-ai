...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <p class="fs-2 mb-0" style="color: #38527E">Tambah Rekan Jejak Riset smart</p>
        </div>
        <!-- Content Row -->
        <div class="row">
            <div class="col-md-12">
                <div class="card p-3">
                    <form id="smart-edit" action="{{ route('smart.update', $smartSistem->id) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="tahun">Tahun <sup class="text-danger">*</sup></label>
                                <input type="number" value="{{ $smartSistem->tahun }}"
                        ...
                        <textarea name="keterangan" class="form-control" id="keterangan" cols="30" rows="5" required>{{ $smartSistem->keterangan }}</textarea>
                        <a href="{{ route('smart.index') }}" class="btn btn-danger float-end mt-3 ml-2">Kembali</a>
...
@push('scripts')
    <script>
        let form = document.getElementById('smart-edit')
