...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <p class="fs-2 mb-0" style="color: #38527E">Tambah Rekan Jejak Riset Smart Sistem</p>
    </div>
    <!-- Content Row -->
    <div class="row">
        <div class="col-md-12">
            <div class="card p-3">
                <form id="smart-baru" action="{{ route('smart.store') }}" method="post"
...
@push('scripts')
<script>
    let form = document.getElementById('smart-baru')
