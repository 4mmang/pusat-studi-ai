                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="level" class="form-control" value="{{ old('level') }}" id="level"
                                    required>
                                    <option @if ($pengabdian->level == 'mandiri') selected @endif value="Mandiri">
                                        Mandiri
                                    </option>
                                    ...
                                    <option @if ($pengabdian->level == 'lainnya') selected @endif value="Lainnya">
                                        Lainnya
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-5 mb-12">
                                ...
                                <select class="form-control mt-2 mb-3" name="anggota[]" id="anggota-select" multiple
                                    ...
                                    @foreach ($anggota as $ang)
                                        <option value="{{ $ang->id }}"
                                            @if (in_array($ang->id, $pengabdian->authors->pluck('id')->toArray())) selected @endif>
                                            {{ $ang->nama }}
                                        </option>
                                    @endforeach
                                </select>
...
@push('scripts')
    <script>
        ...
        let author = @json($pengabdian->authors); // Inisialisasi dengan data penulis yang sudah ada
