...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <p class="fs-2 mb-0" style="color: #38527E">Tambah Data Pengabdian</p>
        </div>
        <!-- Content Row -->
        <div class="row">
            <div class="col-md-12">
                <div class="card p-3">
                    <form id="pengabdian-baru" action="{{ route('pengabdian.store') }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="tanggal_pengabdian" class="">Tanggal Pengabdian <sup
                                        class="text-danger">*</sup></label>
                                <input type="date" value="{{ old('tanggal_pengabdian') }}"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="dana" class="">Dana yang Diperoleh (Rp)<sup class="text-danger">*</sup></label>
                                <input type="number" value="{{ old('dana') }}" class="form-control @error('dana')
                                                                                            is-invalid
                                                                                        @enderror" name="dana" id="dana" placeholder="Rp. 0"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mt-2">
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Tambah author manual">
