                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <form id="delete-pengabdian-{{ $pengab->id }}"
                                                ...
                                                @csrf
                                                @method('delete')
                                                <a href="{{ $pengab->link_akses }}" target="_blank" class="btn btn-primary btn-sm mb-1"><i
                                                        class="fas fa-eye"></i></a>
                                                @php
                                                    $authors = json_decode($pengab->authors, true); // Decode JSON menjadi array
                                                ...
                                                @if ($isUserIdExists || Auth::user()->role === 'admin')
                                                    ...
                                                    <button type="submit"
                                                        onclick="disableDeleteButton({{ $pengab->id }})"
