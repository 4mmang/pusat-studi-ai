                ...
                <form id="penelitian-baru" action="{{ route('penelitian.update', $penelitian->id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" value="{{ $penelitian->judul }}" autofocus class="form-control @error('judul')
                                    is-invalid
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" value="{{ $penelitian->penyelenggara }}" class="form-control @error('penyelenggara')
                                    is-invalid
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="tanggal_penelitian" class="">Tanggal Penelitian <sup
                                    class="text-danger">*</sup></label>
                            <input type="date" value="{{ $penelitian->tanggal_penelitian }}" class="form-control @error('tanggal_penelitian')
                                    is-invalid
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="level" class="form-control" value="{{ old('level') }}" id="level" required>
                                ...
                                <option @if ($penelitian->level == 'internasional') selected @endif
                                    value="Internasional">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="link_akses" class="">Link Akses Penelitian <sup
                                    class="text-danger">*</sup></label>
                            <input type="url" value="{{ $penelitian->link_akses }}" class="form-control @error('link_akses')
                                    is-invalid
